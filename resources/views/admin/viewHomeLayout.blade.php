...
<div class="layout-border">
    ...
    <button class="adding-btn layout-btn"><a href="{{ route('editHomeLayout') }}">Edit Home Layout</a></button>
    ...
    <div class="hero" id="home">
        ...
        <div class="hero-content container">
            <h3>Interior</h3>
            <h1>Design</h1>
            <p>Design has always been my passion ... I honor and appreciate any out of the box design which always seems
                to
                hit a high level of appreciation. Creating a pattern or a curve or even an angled shaped which is unseen
                and
                unfamiliar will always stand out. It is all about ideas, organising, exploring and implementing with a
                neat
    ...
    <div class="container style-section">
        ...
        <h6>Our services are aligning with the new way of life. We make a beautiful design and sustainable furniture.
        </h6>
